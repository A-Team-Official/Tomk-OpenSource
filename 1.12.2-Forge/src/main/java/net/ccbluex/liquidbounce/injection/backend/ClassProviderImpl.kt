...
object ClassProviderImpl : IClassProvider {
    ...
    override fun createGuiTextField(id: Int, iFontRenderer: GameFontRenderer, x: Int, y: Int, width: Int, height: Int): IGuiTextField = GuiTextFieldImpl(GuiTextField(id, iFontRenderer, x, y, width, height))

    override fun createGuiPasswordField(id: Int, iFontRenderer: GameFontRenderer, x: Int, y: Int, width: Int, height: Int): IGuiTextField = GuiTextFieldImpl(GuiPasswordField(id, iFontRenderer, x, y, width, height))
