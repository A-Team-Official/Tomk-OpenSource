...
public class QRLoginScreen extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        FontLoaders.msFont16.drawString(text, res.getScaledWidth() / 2f - (FontLoaders.msFont16.getStringWidth(text) / 2f), 30, 0xFFFFFFFF);
        FontLoaders.msFont16.drawString(state, res.getScaledWidth() / 2f - (FontLoaders.msFont16.getStringWidth(state.replaceAll("\247.", "")) / 2f), 50, 0xFFFFFFFF);
