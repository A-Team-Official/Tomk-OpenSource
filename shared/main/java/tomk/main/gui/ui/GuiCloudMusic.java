...
import tomk.SuperLib;
import tomk.main.gui.MusicManager;
import tomk.main.gui.utils.CloudMusicAPI;
...
public class GuiCloudMusic extends GuiScreen {
    ...
    float scY = scaledResolution.getScaledWidth();

    float scX = scaledResolution.getScaledWidth();
    public float x = scX + 10;
    public float y = scY + 10;
    public float x2 = scX+0;
    public float y2 = scY+ 0;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (Math.ceil(sidebarAnimation) > 1) {
            ...
            FontLoaders.msFont13.drawString("导入", newWidth - 23f, y + 8f, new Color(240, 240, 240).getRGB());

            if (textField.textString.isEmpty()) {
                FontLoaders.msFont13.drawString("输入歌单ID", newX + 8, y + 8f, Color.WHITE.getRGB());
            }
        ...
        FontLoaders.msFont16.drawString("网易云音乐", x + 15, y + 8, Color.BLACK.getRGB());
        ...
        FontLoaders.msFont16.drawString(songName, x + (width / 2) - (FontLoaders.msFont16.getStringWidth(songName) / 2f) - 1.5f, y + (height / 2 - 90), Color.BLACK.getRGB());
        FontLoaders.msFont13.drawString(songArtist, x + (width / 2) - (FontLoaders.msFont13.getStringWidth(songArtist) / 2f) - 1.5f, y + (height / 2 - 82), Color.BLACK.getRGB());
        GL11.glDisable(GL11.GL_SCISSOR_TEST);
