...
public class ValuesConfig extends FileConfig {
    public static boolean useGlyphFontRenderer = true;
        ...
        if (LiquidBounce.INSTANCE.getConfigchose() == 234675 || LiquidBounce.INSTANCE.getConfigchose() == 980340) {
            ...
            while (iterator.hasNext()) {
                ...
                if (entry.getKey().equalsIgnoreCase("CommandPrefix")) {
                    ...
                    if (jsonValue.has("use-glyph-fontrenderer")) {
                        useGlyphFontRenderer = jsonValue.get("use-glyph-fontrenderer").getAsBoolean();
                    }
    ...
    protected void saveConfig() throws IOException {
        if (LiquidBounce.INSTANCE.getConfigchose() == 234675 || LiquidBounce.INSTANCE.getConfigchose() == 980340) {
            ...
            jsonObject.addProperty("use-glyph-fontrenderer", useGlyphFontRenderer);
