...
class Velocity : Module() {
    ...
    private val modeValue = ListValue("Mode", arrayOf("Verne","TomkHaohao","TEST","HytBest","HuaYuTingJump","Custom","AAC4","Simple", "SimpleFix","AAC", "AACPush", "AACZero",
            "Reverse", "SmoothReverse", "Jump", "AAC5Reduce", "HytPacketA" ,"Glitch","HytCancel","HytTick","Vanilla","HytTest","HytNewTest","HytPacket","NewAAC4","Hyt","FeiLe","HytMotion","NewHytMotion","HytPacketB","HytMotionB","HytPacketFix","NoXZ","Tomk"), "Vanilla")
