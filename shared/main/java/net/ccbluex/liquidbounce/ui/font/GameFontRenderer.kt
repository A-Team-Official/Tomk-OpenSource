...
class GameFontRenderer(font: Font) : FontRenderer(
    ...
    override fun drawString(text: String, x: Int, y: Int, color: Int): Int = drawString(text, x.toFloat(),
        y.toFloat(), color,false)

     fun drawString(text: String, x: Float, y: Float, color: Int): Int = drawString(text, x, y, color,false)

    override fun drawStringWithShadow(text: String, x: Float, y: Float, color: Int) =drawString(text, x, y, color, true)
     fun drawStringWithShadow(text: String?, x: Int, y: Int, color: Int) = drawString(
    ...
    fun drawCenteredString(s: String, x: Double, y: Double, color: Int) =
        drawStringWithShadow(s, (x - getStringWidth(s) / 2F).toFloat(), y.toFloat(), color)
    fun drawCenteredString2(s: String, x: Double, y: Double, color: Int) =
        drawString(s, x.toFloat() - getStringWidth(s) / 2F, y.toFloat(), color)

    override fun drawString(text: String, x: Float, y: Float, color: Int, shadow: Boolean): Int {
        val currentText = text.let { LanguageManager.replace(it) }
    ...
    private fun drawText2(text: String?, x: Float, y: Float, colorHex: Int, ignoreColor: Boolean): Int {
