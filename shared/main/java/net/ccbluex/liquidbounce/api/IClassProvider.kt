...
interface IClassProvider {
    ...
    fun createGuiTextField(id: Int, iFontRenderer: GameFontRenderer, x: Int, y: Int, width: Int, height: Int): IGuiTextField
    fun createGuiPasswordField(id: Int, iFontRenderer: GameFontRenderer, x: Int, y: Int, width: Int, height: Int): IGuiTextField
