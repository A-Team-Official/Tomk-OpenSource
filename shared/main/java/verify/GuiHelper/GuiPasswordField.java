    ...
    public void drawTextBox2() {
        if (this.getVisible()) {
            ...
            if (s.length() > 0) {
                ...
                j1 = (int) FontLoaders.xyz18.drawString(s1.replaceAll(".", "*"), (float) l, (float) (i1 + 4), (new Color(0, 0, 0)).getRGB());
            }
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                FontLoaders.xyz18.drawString(s.substring(j).replaceAll(".", "*"), (float) (j1 + 2), (float) (i1 + 4), (new Color(0, 0, 0)).getRGB());
            }
