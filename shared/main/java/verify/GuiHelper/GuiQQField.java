...
public final class GuiQQField extends Gui {
    ...
    public GuiQQField(FontRenderer p_i1032_1_, int p_i1032_2_, int p_i1032_3_, int p_i1032_4_, int p_i1032_5_) {
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            boolean flag = j >= 0 && j <= s.length();
             flag1 = this.isFocused && this.cursorCounter / 6 % 2 == 0 && flag;
        ...
        if (this.getVisible()) {
            ...
            if (flag1) {
                if (flag2) {
                    ...
                    FontLoaders.xyz20.drawString("_", (float) (k1 + 1), (float) i1, i);
                }
            }
